...
class Progress(object):
  ...
  def update(self, inc=1, msg=''):
    ...
    if self._total <= 0:
      sys.stderr.write('\r\033[1;33m%s: %d,%s\033[0;0m' % (
          self._title,
          self._done,
      ...
      if self._show_jobs:
        ...
        jobs = ''
      sys.stderr.write('\r\033[1;33m%s: %2d%% %s(%d%s/%d%s)\033[0;0m%s%s%s%s' % (
          self._title,
          p,
          jobs,
  ...
  def end(self):
    ...
    if self._total <= 0:
      sys.stderr.write('\r\033[1;33m%s: %d, done in %s%s\033[0;0m\n' % (
          self._title,
          self._done,
          duration,
          CSI_ERASE_LINE_AFTER))
      ...
      p = (100 * self._done) / self._total
      sys.stderr.write('\r\033[1;33m%s: %3d%% (%d%s/%d%s), done in %s%s\033[0;0m\n' % (
          self._title,
          p,
          self._done, self._units,
          self._total, self._units,
